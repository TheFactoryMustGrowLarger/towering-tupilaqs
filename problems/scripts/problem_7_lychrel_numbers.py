def is_lychrel(number):
    """This function assesses weather an integer is a Lychrel number or not.
    ...
    196, 196+691 = 887, 887+788 = 1675 it's not proven yet, but it's thought that it will never produce a palindrome.
    We shall assume that if a number does not produce a palindrome after 50 iterations,
